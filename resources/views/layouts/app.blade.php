...
<head>
	...
	<style>
        ...
        .btn-danger{
            ...
            border-color: #6C648B !important;
        }
        .bg-primary{
            background-color: #9d90bf !important;
        }
        .badge-danger{
	...
	<div class="row">
		...
		<div class="col-sm-9 col-md-10">
			...
			<ul class="nav nav-tabs">
				<li class="nav-item">
                    @if(Route::currentRouteName() == 'inbox.index')
                        <a class="nav-link active" href="#home" data-toggle="tab">
                            <i class="fa fa-inbox"></i> Inbox
                        </a>
                    @endif

                    @if(Route::currentRouteName() == 'sent.index')
                        <a class="nav-link active" href="#home" data-toggle="tab">
                            <i class="fa fa-paper-plane"></i> Sent Mail
                        </a>
                    @endif
				</li>
				{{--
