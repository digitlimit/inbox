...
namespace Digitlimit\Inbox\Traits;

use Carbon\Carbon;
use Digitlimit\Inbox\Events\NewMessageDispatched;
use Digitlimit\Inbox\Events\NewReplyDispatched;
...
trait HasInbox
{
    ...
    public function reply($thread)
    {
        ...
        $participant = $participantClass::firstOrCreate([
            'thread_id' => $thread->id,
            'user_id' => $this->id,
            'sender_id' => $this->id //TODO: maybe mark this as sender
        ]);
